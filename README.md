...
☁️ Conhecimento sólido em **infraestrutura cloud (GCP), Langflow, Argo e Python**.  
...
- **Integração de Sistemas:** Conexão entre **sistemas legados e novas tecnologias** para modernização de processos.  
...
🤖 **Orquestração de Fluxos RPA:** Implementação de um sistema de automação baseado no **Langflow e Argo**.  
